const locators = {
  ...
  cruiseCards: (page) => page.locator('article[class*="cruise-card"], div[class*="cruise-card"]'),
  firstCruiseCard: (page) => page.locator('article[class*="cruise-card"], div[class*="cruise-card"]').first(),
